  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        <Text style={styles.title}>{isNear ? '•••' : user.name}</Text>
        <Text style={styles.subtitle}>{isNear ? '••••••••' : user.email}</Text>
        <View style={styles.row}>
          <View style={styles.stat}>
            <Text style={styles.statLabel}>Rol</Text>
            <Text style={styles.statValue}>{isNear ? '•••' : user.role}</Text>
          </View>
          <View style={styles.stat}>
            <Text style={styles.statLabel}>Puntos</Text>
            <Text style={styles.statValue}>{isNear ? '•••' : user.points}</Text>
          </View>
        </View>

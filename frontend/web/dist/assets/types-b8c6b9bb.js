import { g as get, s as set, a as appendErrors } from "./index.esm-0ed2c915.js";
const s = (e, s2, o2) => {
    ...
    try {
      return Promise.resolve(function(e, n2) {
        ...
        if (function(r2) {
          ...
          return { values: {}, errors: r(n(r$1.errors, !u.shouldUseNativeValidation && "all" === u.criteriaMode), u) };
        throw r$1;
      }));
    } catch (r2) {
...
function addIssueToContext(ctx, issueData) {
  ...
  const issue = makeIssue({
    ...
    errorMaps: [
      ...
      overrideMap,
      // then globalThis override map
      overrideMap === defaultErrorMap ? void 0 : defaultErrorMap

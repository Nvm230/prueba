      ...
      <div className="card bg-gradient-to-br from-primary-50 to-primary-100/30 dark:from-primary-900/20 dark:to-primary-800/10 border-primary-200 dark:border-primary-800">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h3 className="text-sm font-semibold text-slate-900 dark:text-white mb-1">¿Cómo funcionan las notificaciones?</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
              {canSendNotifications ? (
                <>
                  Como <strong>{user?.role}</strong>, puedes enviar notificaciones a cualquier usuario del sistema. 
